  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-muted">5 independent revenue streams NOT dependent on TikTok followers. Scales from $2K → $10K+/mo by Month 18.</p>
      </div>

      <div className="bg-purple-50 p-4 rounded-lg">
        <h3 className="font-bold mb-3">Revenue Forecast</h3>
      ...
      <div className="bg-yellow-50 p-4 rounded-lg">
        <h3 className="font-bold mb-2">⚠️ The Problem This Solves</h3>
        <p className="text-sm"><strong>TikTok followers are unreliable:</strong> Algorithm changes, viral stops, platform can vanish.</p>
        <p className="text-sm mt-2"><strong>Solution:</strong> Build 5 channels that compound independently + feed into each other.</p>
      </div>
      ...
      <div className="space-y-3">
          ...
          {expandedSection === 'channel1' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div className="p-3 bg-white rounded border">
                ...
                <p className="mt-2 font-bold">Combined monthly opportunity: 1,400+ visitors</p>
              </div>
              <div className="p-3 bg-white rounded border">
                <strong>Content Roadmap (60 days):</strong>
                <ul className="mt-2 text-xs space-y-1">
              ...
              <div className="p-3 bg-white rounded border">
                <strong>Expected Results (6 months):</strong>
                <ul className="mt-2 text-xs space-y-1">
                  <li>• 500-800 monthly organic visitors</li>
                  <li>• 5-10% email captures = 25-80 new subscribers/mo</li>
                  <li>• 2-3% convert to $97-297 readings = <strong>$97-891/mo</strong></li>
                </ul>
              </div>
              <div className="p-3 bg-blue-50 rounded text-xs">
                <strong>Tools:</strong> WordPress + Yoast SEO ($120/yr) + Semrush ($100-200/mo)<br/>
                <strong>Cost:</strong> $200-300/mo
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border rounded-lg">
          ...
          {expandedSection === 'channel2' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div>
                <strong>Goal:</strong> 10,000 email subscribers who trust you enough to buy
              </div>
              <div className="p-3 bg-white rounded border">
              ...
              <div className="p-3 bg-blue-50 rounded text-xs">
                <strong>Expected Results (6 months):</strong> 500-1,000 new subscribers/mo = 3K-6K total list<br/>
                <strong>Revenue:</strong> <strong>$1,970-4,455/mo from email alone</strong>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border rounded-lg">
          ...
          {expandedSection === 'channel3' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div className="p-3 bg-white rounded border">
                <strong>Product 1: Numerology Mini-Course ($197)</strong>
                <ul className="mt-2 text-xs space-y-1">
                  <li>• 4-5 videos (4 hours to record)</li>
                  <li>• Life Path basics, destiny, cycles, daily use</li>
                  <li>• Expected sales: 10-20/mo = <strong>$1,970-3,940/mo</strong></li>
                </ul>
              </div>
              <div className="p-3 bg-white rounded border">
                <strong>Product 2: 4-Week Workshop ($997)</strong>
                <ul className="mt-2 text-xs space-y-1">
                  <li>• 4 weekly live Zoom calls (1 hour each)</li>
                  <li>• Group size: 10-15 people</li>
                  <li>• Launch quarterly = <strong>$9,970-14,955/launch</strong></li>
                  <li>• Annual: <strong>$40K-60K</strong></li>
                </ul>
              </div>
              <div className="p-3 bg-white rounded border">
                <strong>Product 3: Numerology for Entrepreneurs ($397)</strong>
                <ul className="mt-2 text-xs space-y-1">
                  <li>• Business-focused course</li>
                  <li>• Life path in business, brand naming, pricing, cycles</li>
                  <li>• Expected sales: 5-10/mo = <strong>$1,985-3,970/mo</strong></li>
                </ul>
              </div>
              <div className="p-3 bg-blue-50 rounded text-xs">
                <strong>Total Products Revenue (6 months):</strong> $4K-9K/mo
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border rounded-lg">
          ...
          {expandedSection === 'channel4' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              ...
              <div className="p-3 bg-white rounded border">
                <strong>Partnership 2: TikTok Creator Collabs</strong>
                <p className="text-xs mt-2">Duets, stitches, joint lives with creators in complementary niches.</p>
                <p className="text-xs mt-1"><strong>Expected:</strong> 2-3% email capture from 50K-100K audience = 1,000-3,000 subscribers/mo → <strong>$2,000/mo</strong></p>
              </div>
              <div className="p-3 bg-white rounded border">
                <strong>Partnership 3: Podcasts & Guest Appearances</strong>
                <p className="text-xs mt-2">Target 20-30 podcasts. Do 1-2 appearances/month.</p>
                <p className="text-xs mt-1"><strong>Expected:</strong> 3-5 readings per podcast × 4-5 appearances/mo = <strong>$4K-7K/mo</strong></p>
              </div>
              <div className="p-3 bg-blue-50 rounded text-xs">
                <strong>Total Partnership Revenue (6 months):</strong> $9K+/mo
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border rounded-lg">
          ...
          {expandedSection === 'channel5' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div className="p-3 bg-white rounded border">
                <strong>Goal:</strong> 100 members × $44/mo = <strong>$4,400/mo by Month 9</strong>
              </div>
              <div className="p-3 bg-white rounded border">
              ...
              <div className="p-3 bg-blue-50 rounded text-xs">
                <strong>Unit Economics:</strong> Platform cost $9/mo → Margin $35/member → $3,500/mo at 100 members
              </div>
            </div>
          )}
        </div>
          ...
          {expandedSection === 'roadmap' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div className="p-3 bg-white rounded">
                ...
                <p className="text-xs font-bold mt-2">Revenue target: $1-2K</p>
              </div>
              <div className="p-3 bg-white rounded">
                <strong>Month 2 (Mar):</strong>
                <ul className="mt-2 text-xs space-y-1">
                ...
                <p className="text-xs font-bold mt-2">Revenue target: $3-5K</p>
              </div>
              <div className="p-3 bg-white rounded">
                <strong>Month 3 (Apr):</strong>
                <ul className="mt-2 text-xs space-y-1">
                ...
                <p className="text-xs font-bold mt-2">Revenue target: $5-8K</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border rounded-lg">
          ...
          {expandedSection === 'autonomy' && (
            <div className="p-4 border-t bg-slate-50 space-y-3 text-sm">
              <div className="p-3 bg-white rounded">
                <strong>You Do (10 hours/week):</strong>
                <ul className="mt-2 text-xs space-y-1">
              ...
              <div className="p-3 bg-white rounded">
                <strong>Automation/VA Does:</strong>
                <ul className="mt-2 text-xs space-y-1">
      ...
      <div className="text-center p-4 bg-slate-100 rounded-lg">
        <p className="text-sm font-bold">Full plan: See <code>/workspace/SPIRITUAL_TECHNOLOGIST_GROWTH.md</code></p>
      </div>
    </div>
  );
}
